...
[_BASE] = LAYOUT(
  ...
  KC_GRV,     KC_Q,         KC_W,         KC_E,         KC_R,           KC_T,             RGUI(KC_DOWN),   KC_Y,         KC_U,           KC_I,         KC_O,         KC_P,              KC_BSPC,
...
[_GAME] = LAYOUT(
  KC_ESC,     KC_1,         KC_2,         KC_3,         KC_4,           KC_5,             RGUI(KC_RIGHT),  KC_6,         KC_7,           KC_8,         KC_9,         KC_0,              TD(BSK_PRI_SEARCH),
  KC_GRV,     KC_Q,         KC_W,         KC_E,         KC_R,           KC_T,             RGUI(KC_DOWN),   KC_Y,         KC_U,           KC_I,         KC_O,         KC_P,              KC_BSPC,
  KC_TAB,     KC_A,         KC_S,         KC_D,         KC_F,           KC_G,             RGUI(KC_LEFT),   KC_H,         KC_J,           KC_K,         KC_L,         KC_SCLN,           KC_QUOT,
  KC_LSFT,    KC_Z,         KC_X,         KC_C,         KC_V,           KC_B,   KC_MUTE,  RGUI(KC_PGUP),   KC_N,         KC_M,           KC_COMM,      KC_DOT,       KC_SLSH,           KC_RSFT,
              KC_LGUI,      KC_LALT,      KC_LCTL,      KC_SPC,         KC_SPC,           RGUI(KC_UP),     KC_ENT,       KC_ENT,         KC_RALT,      M0,           TG(3)
)
};
